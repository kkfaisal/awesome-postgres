...
* [DBeaver](http://dbeaver.jkiss.org/) - Free, multi-platform, Support all popular databases: MySQL, PostgreSQL, SQLite, Oracle, DB2, SQL Server, Sybase, MongoDB, etc.
...
* Go: [Golang Postgres driver](https://github.com/lib/pq)
